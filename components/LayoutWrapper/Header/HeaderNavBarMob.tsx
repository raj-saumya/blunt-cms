...
const AnchorLabel: FC<IAnchorLabel> = ({ title, path, asPath }) => (
  <label
    className={`cursor-pointer font-splinespace text-base hover:text-white rounded ${
...
const HeaderLink: FC<IHeaderLink> = ({ handleCloseNavPanel, title, path }) => {
...
const HeaderNavBarMob: FC<IHeaderNavBarMob> = ({ navItems }) => {
